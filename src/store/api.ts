...
export const api = createApi({
  ...
  tagTypes: ["UserList", "Product", "ProductOperations", "Identifier", "Company", "PendingSchedule", "TransactionLog", "ReworkTransactionLog", "ScheduleOperations", "ProductionMonitoringLog", "ReworkMonitoringLog", "CompletedSchedule", "ReworkCompletedSchedule", "HandoverToStore", "ReworkHandoverToStore", "Store", "Notification", "NotificationSettings", "ReworkSchedule", "ReworkScheduleOperations", "ProcessTeam", "OperationQrScanCount", "ReworkQrScanCount"],
  endpoints: () => ({}),
})
