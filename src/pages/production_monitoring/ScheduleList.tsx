...
import { PRODUCTION_SCHEDULES, REWORK_SCHEDULES, pad2 } from "./data"
...
export function ScheduleList({ scheduleType, onSelect }: Props) {
  const schedules = scheduleType === "production" ? PRODUCTION_SCHEDULES : REWORK_SCHEDULES
  const label     = scheduleType === "production" ? "Production" : "Rework"

  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-4">
        <p className="text-sm font-semibold text-gray-800">View {label} Schedules</p>
