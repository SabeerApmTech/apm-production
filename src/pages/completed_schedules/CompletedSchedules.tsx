...
const ALL_SCHEDULES: CompletedScheduleRow[] = [
  {
    id: 1,
    scheduleDate: "2026-05-26", scheduleId: "S001-26",
    company: "Lakshika", product: "AIS 140",
    noOfOperations: 19, targetQty: 3000,
    targetDate: "2026-06-17", completedDate: "2026-06-17",
    createdBy: "2547 : Basheer",
  },
  {
    id: 2,
    scheduleDate: "2026-05-26", scheduleId: "S002-26",
    company: "Kingstrack", product: "Dashcam",
    noOfOperations: 8, targetQty: 2000,
    targetDate: "2026-06-17", completedDate: "2026-06-17",
    createdBy: "2547 : Basheer",
  },
  {
    id: 3,
    scheduleDate: "2026-05-26", scheduleId: "S003-26",
    company: "Kingstrack", product: "CC TV",
    noOfOperations: 12, targetQty: 3000,
    targetDate: "2026-06-17", completedDate: "2026-06-17",
    createdBy: "2547 : Basheer",
  },
  {
    id: 4,
    scheduleDate: "2026-05-10", scheduleId: "S004-26",
    company: "Lakshika", product: "AIS 140",
    noOfOperations: 15, targetQty: 1500,
    targetDate: "2026-05-25", completedDate: "2026-05-24",
    createdBy: "2547 : Basheer",
  },
  {
    id: 5,
    scheduleDate: "2026-04-15", scheduleId: "S005-26",
    company: "ABC", product: "Dashcam",
    noOfOperations: 10, targetQty: 2500,
    targetDate: "2026-04-30", completedDate: "2026-04-29",
    createdBy: "2547 : Basheer",
  },
]
...
export function CompletedSchedules() {
  ...
  const filterBar = (
    <div className="flex flex-wrap items-end gap-3">
      ...
      {(fromDate || toDate) && (
        <Button variant="outline" onClick={handleClear} className="h-10 text-sm">
          Clear
        </Button>
      )}
    </div>
