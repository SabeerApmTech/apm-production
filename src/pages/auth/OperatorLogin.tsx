...
export const OperatorLogin = () => {
  ...
  return (
    <div className="force-light h-dvh overflow-hidden flex items-center justify-center bg-gray-100 px-4">
      <div className="w-[95vw] h-[92vh] max-w-[1400px] flex flex-col md:flex-row rounded-2xl overflow-hidden shadow-2xl bg-white">

        {/* Left — profile selection */}
        <div className="w-full md:w-1/2 flex flex-col relative min-h-0">
          {/* Back To Main Screen — top-right corner */}
          <button
            type="button"
            onClick={() => navigate("/login")}
            className="absolute top-4 right-4 text-xs rounded-lg px-3 py-1.5 border font-medium transition text-[#1a2a4a] border-[#1a2a4a] hover:bg-[#1a2a4a] hover:text-white z-10"
          >
            Back To Main Screen
          </button>
